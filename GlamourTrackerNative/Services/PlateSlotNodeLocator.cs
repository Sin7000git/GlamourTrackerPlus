...
internal static unsafe class PlateSlotNodeLocator
{
    ...
    {
        // No sticky cache — layout is fully driven by Configuration each frame.
    }
    ...
    {
        config.SlotRerollFirstRowY = 0.20f;
        config.SlotRerollLastRowY = 0.58f;
        config.SlotRerollLeftColumnX = 0.08f;
        config.SlotRerollRightColumnX = 0.92f;
        config.SlotRerollIconSize = 0.055f;
        config.SlotRerollTowardCenter = false;
        config.SlotRerollNudgeX = 0f;
        config.SlotRerollNudgeY = 0f;
        config.SlotRerollGap = 3f;
    }
